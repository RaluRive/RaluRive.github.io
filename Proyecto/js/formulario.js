document.addEventListener("DOMContentLoaded", () => {
    ...
    let formulario=document.getElementById("main__form");
    ...
    function camposCompletados() {
        ...
        if (contraseñaError) {
            ...
            contraseña.setCustomValidity("La contraseña no es segura. Debe: \n -Contener un numero\n -Contener una mayuscula\n -Contener una minuscula\n -Contener un simbolo (!@#$%^&*()\\-_+.)\n -Tener 8 o mas caracteres");
        }
    ...
    contraseñaConfirmacion.addEventListener("input", (event) => {
        ...
        contraseñaConfirmacionError = (contraseñaConfirmacion.value == contraseña.value && contraseñaConfirmacion.checkValidity());
        camposCompletados();
        event.target.reportValidity();
    })
